...
export default function AssignmentsPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-12">
      ...
      {/* Filter & View Toolbar */}
      <div className="bg-white border border-slate-200/80 rounded-2xl p-3.5 sm:p-4 shadow-card space-y-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              placeholder="Cari tugas atau instruksi..."
          ...
          <div className="flex items-center gap-1 w-full sm:w-auto p-1 bg-slate-100/80 rounded-xl shrink-0">
            <button
              onClick={() => setViewMode("kanban")}
              className={`flex-1 sm:flex-initial px-3 py-1.5 text-xs font-heading font-medium rounded-lg flex items-center justify-center gap-1.5 transition-all select-none ${
                viewMode === "kanban"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-5">
          {STATUS_COLUMNS.map((column) => {
            ...
            return (
              <div
                key={column.id}
                className="bg-slate-50/70 border border-slate-200/80 rounded-2xl flex flex-col min-h-[350px] overflow-hidden"
              >
                {/* Column Header */}
                  ...
                  {columnTasks.length === 0 ? (
                    ...
                    columnTasks.map((task) => {
                      ...
                      return (
                        <div
                          key={task.id}
                          className="bg-white border border-slate-200/80 rounded-xl shadow-soft-xs hover:shadow-soft-sm transition-all p-3.5 space-y-2"
                        >
      ...
      {/* 2. LIST TABLE VIEW WITH HORIZONTAL TOUCH SWIPER */}
                ...
                {filteredAssignments.map((task) => {
                  ...
                  return (
                    <tr key={task.id}>
                      ...
                      <td className="text-xs font-medium text-rose-600 whitespace-nowrap">
